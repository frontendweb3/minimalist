        ...
        <>
            <main className="my-16 pt-8 pb-16 lg:pt-16 lg:pb-24 bg-white dark:bg-gray-900">
                ...
                <div className="flex flex-col justify-between px-4 mx-auto max-w-screen-xl">
                    ...
                    <div style={{ backgroundImage: "url(https://cdn.pixabay.com/photo/2023/01/07/08/41/leaves-7702829__340.jpg)" }} className="rounded-t-lg bg-fixed h-[650px] w-full bg-origin-content  bg-cover bg-no-repeat p-2"></div>
                    ...
                    <article className="my-12 prose lg:prose-xl w-full mx-auto max-w-4xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
                        ...
                        <h1 style={{ margin: "0px" }} className="prose-h1:my-0 text-3xl font-extrabold leading-tight text-gray-900 lg:text-4xl dark:text-white">Best practices for successful prototypes</h1>

                        <p style={{ margin: "0px" }} className="text-1xl font-extrabold leading-tight text-gray-500 lg:text-xl dark:text-white">Flowbite is an open-source library based on tailwind CSS framework </p>
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <div className="flex flex-col md:flex-row ">
                                        ...
                                        <p style={{ "margin": "0px" }} className="ml-3 text-base font-light text-gray-500 dark:text-gray-400">
                                            <time className="ml-0 md:ml-2" dateTime="2022-02-08" title="February 8th, 2022">Feb 8, 2022</time>
                                        </p>
                                    </div>
                        ...
                        <figure className="w-full my-12">
                            ...
                            <img className="mx-auto" src="https://flowbite.s3.amazonaws.com/typography-plugin/typography-image-1.png" alt="Typegraphy image is here" />
                        ...
                        <pre>
                            <code className="language-html">
                               ...
                               <span className='w-full text-slate-100'>
                                let name="Minimalist"
                                </span> 
                                <br/>
                                <span className='w-full text-slate-100 py-2'> 
                                let themeType = "theme"
                                </span>
                                <br/>
                                <span className='w-full text-slate-100'> 
                                console.log(name, themeType)
                                </span>
                            </code></pre>
            ...
            <div className="container mx-auto">
                ...
                <h1 className="mb-2 text-4xl font-bold tracking-tight text-gray-900 dark:text-white px-10"> Read more </h1>
