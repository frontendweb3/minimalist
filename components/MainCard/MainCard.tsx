...
export default function Card() {
  return (
    <>
      <div className="my-16 p-4 sm:6 md:p-12 lg:p-12 mx-auto flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow lg:flex-row md:max-w-full justify-center hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
