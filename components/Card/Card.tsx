    ...
    return (
        <div className="w-full h-full bg-white dark:bg-gray-900">
            <div className="my-14 mx-0  md:mx-5 lg:mx-10 xl:mx-14 flex flex-col max-w-6xl max-h-xl">
                ...
                <div style={{ backgroundImage: `url(${item.image})` }} className="rounded-t-lg  h-[350px] bg-origin-content bg-cover bg-no-repeat p-2 m-3 "></div>
                ...
                <div className="p-5">
                    ...
                    <div className="flex flex-row justify-between">
                        ...
                        <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" className="text-black dark:text-white relative font-medium rounded-lg text-sm px-4 text-center inline-flex items-center" type="button">

                            <span className="sr-only">Open dropdown</span>

                            <svg width="64" className="black-white dark:text-white" aria-hidden="true" height="48" viewBox="0 0 54 48" fill="none" xmlns="http://www.w3.org/2000/svg">
