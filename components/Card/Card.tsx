    ...
    return (
        <div className="w-full h-full bg-white dark:bg-gray-900">
            <div className="my-14 mx-0  md:mx-5 lg:mx-10 xl:mx-14 flex flex-col max-w-6xl max-h-xl">
                ...
                <Image priority={true} height={350} width={1224} alt={item.title} src={`/minimalist${item.image}`} className="h-[450px] rounded-t-lg bg-origin-content bg-cover bg-no-repeat p-2 m-3 " />
