...
export default function Card() {
    return (
        <>
            <div className="my-12 max-w-6xl  bg-white border border-gray-100 rounded-lg dark:bg-gray-800 dark:border-gray-700">

                <div style={{ backgroundImage: "url(https://cdn.pixabay.com/photo/2023/01/07/08/41/leaves-7702829__340.jpg)" }} className="rounded-t-lg bg-fixed h-[250px] bg-origin-content bg-cover bg-no-repeat p-2 m-3 "></div>

                <div className="p-5">

                    <Link href="/read/my-name">
                        <h5 className="mb-2 px-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Noteworthy technology acquisitions 2021</h5>
                    </Link>
                    ...
                    <div className="flex flex-row justify-between">
                        ...
                        <button id="dropdownButton" data-dropdown-toggle="dropdown" className="inline-block text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none rounded-lg text-sm p-1.5" type="button">
                            <span className="sr-only">Open dropdown</span>

                            <svg width="54" aria-hidden="true" height="48" viewBox="0 0 54 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="hidden  justify-end px-4 pt-4">
                ...
                <div id="dropdown" className="z-10 hidden text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                    <ul className="py-2" aria-labelledby="dropdownButton">
                        <li>
                            <Link href="#" className="block px-4 py-2 text-sm text-red-600 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Bookmark</Link>
                        </li>
                        <li>
                            <Link href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Share</Link>
                        </li>
                        <li>
                            <Link href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Comment</Link>
                        </li>
