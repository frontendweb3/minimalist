        ...
        <div className="my-12 max-w-6xl  bg-white border border-gray-100 rounded-lg dark:bg-gray-800 dark:border-gray-700">
            ...
            <div className="p-5">
                ...
                <div className="flex flex-row justify-between">
                    ...
                    <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" className="text-white relative font-medium rounded-lg text-sm px-4 text-center inline-flex items-center" type="button">

                        <span className="sr-only">Open dropdown</span>

                        <svg width="64" aria-hidden="true" height="48" viewBox="0 0 54 48" fill="none" xmlns="http://www.w3.org/2000/svg">
